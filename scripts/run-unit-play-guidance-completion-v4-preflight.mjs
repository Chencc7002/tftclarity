...
const result = runCompletionV4Preflight({ config, corpus, observations, sourcePreflight });
const output = path.join(root, "eval/skills/unit-play-guidance-completion-v4/preflight-result.v4.json");
