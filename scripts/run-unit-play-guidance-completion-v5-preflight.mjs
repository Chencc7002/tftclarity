...
const result = runCompletionV5Preflight({ config, corpus, observations, sourcePreflight });
const output = path.join(root, "eval/skills/unit-play-guidance-completion-v5/preflight-result.v5.json");
