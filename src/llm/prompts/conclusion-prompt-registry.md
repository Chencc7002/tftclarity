...
| `unit_item_rankings` | `conclusion-intents/unit-item-rankings.md` | `unit-item-rankings.v1` |
...
`unit_details`、`item_details`、`trait_details` 当前明确不注册结论 Prompt：它们只做结构化查询和前端资料展示。相关静态文本可以参与意图与实体语义检索，但不触发 LLM 数据解读。
