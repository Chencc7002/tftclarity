...
export const COMPLETION_V4_EXPERIMENT_ID = "unit-play-guidance-completion.2026-09-01.v4";
export const COMPLETION_V4_SCHEMA = "unit-play-guidance-completion-preflight.v4";

export function buildCompletionV4Plan(config, corpus) {
...
export function runCompletionV4Preflight({ config, corpus, observations, sourcePreflight }) {
  ...
  const gates = {
    configIdentity: config?.schemaVersion === "unit-play-guidance-completion-config.v4"
      && config.experimentId === COMPLETION_V4_EXPERIMENT_ID,
  ...
  return { schemaVersion: COMPLETION_V4_SCHEMA, experimentId: COMPLETION_V4_EXPERIMENT_ID,
