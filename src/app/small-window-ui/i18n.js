...
export const messages = {
  "zh-CN": {
    ...
    unitDetails: "棋子详情", unitCost: "{value} 费", traitDetails: "羁绊详情", baseStats: "基础属性", ability: "技能", traitTiers: "羁绊档位", stableItemRecommendations: "稳定装备推荐", recommendationScore: "稳定分", recommendationMethod: "按样本数从高到低排序；平均名次与前四率仅作表现参考，不参与排序。", health: "生命值", mana: "法力值", attackDamage: "攻击力", armor: "护甲", magicResist: "魔抗", attackSpeed: "攻速", attackRange: "攻击距离", critChance: "暴击率", startingMana: "初始法力", noStableItems: "暂无足够的稳定装备样本。", traitRace: "种族羁绊", traitJob: "职业羁绊", unitsRequired: "{value} 人",
  ...
  "en-US": {
    ...
    unitDetails: "Unit details", unitCost: "{value}-cost", traitDetails: "Trait details", baseStats: "Base stats", ability: "Ability", traitTiers: "Trait tiers", stableItemRecommendations: "Stable item recommendations", recommendationScore: "Stability", recommendationMethod: "Sorted by sample size from highest to lowest; average placement and Top 4 rate are shown for context only.", health: "Health", mana: "Mana", attackDamage: "Attack damage", armor: "Armor", magicResist: "Magic resist", attackSpeed: "Attack speed", attackRange: "Range", critChance: "Crit chance", startingMana: "Starting mana", noStableItems: "No stable item sample is available yet.", traitRace: "Origin trait", traitJob: "Class trait", unitsRequired: "{value} units",
