...
export const messages = {
  "zh-CN": {
    ...
    advancedDefaults: "高级查询默认值", queryConditions: "查询条件", sampleThreshold: "样本阈值", itemScope: "装备范围", ordinary: "普通",
    radiant: "光明", artifact: "神器", special: "特殊", sort: "排序", sortTop4: "前四优先", sortWin: "吃鸡优先", sortRobust: "稳健优先",
  ...
  "en-US": {
    ...
    advancedDefaults: "Advanced query defaults", queryConditions: "Query conditions", sampleThreshold: "Sample threshold", itemScope: "Item scope", ordinary: "Normal",
    radiant: "Radiant", artifact: "Artifact", special: "Special", sort: "Sort", sortTop4: "Top 4 first", sortWin: "Win first", sortRobust: "Robust first",
