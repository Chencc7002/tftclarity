...
export const messages = {
  "zh-CN": {
    ...
    radiant: "光明", artifact: "神器", emblem: "纹章", special: "特殊", sort: "排序", sortTop4: "前四优先", sortWin: "吃鸡优先", sortRobust: "普适稳健",
    ...
    chatCoreTitle: "核心结论", chatCoreScope: "仅基于本次展示组合", chatCoreWithItems: "本次展示 {count} 套装备组合，{items} 均至少出现在 {required} 套中，达到 2/3 频率阈值，因此判断为 {unit} 的当前核心装备倾向。", chatCoreWithoutItems: "本次展示 {count} 套装备组合，没有装备至少出现在 {required} 套中，因此暂不判断 {unit} 存在固定核心装备。", chatFurtherInterpretation: "进一步数据解读",
  ...
  "en-US": {
    ...
    radiant: "Radiant", artifact: "Artifact", emblem: "Emblem", special: "Special", sort: "Sort", sortTop4: "Top 4 first", sortWin: "Win first", sortRobust: "Applicability",
