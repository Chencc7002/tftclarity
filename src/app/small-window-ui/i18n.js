...
export const messages = {
  "zh-CN": {
    ...
    improvingComps: "近 3 天排名上升的阵容", avgPlacementImproved: "平均名次提升 {value}",
  ...
  "en-US": {
    ...
    improvingComps: "Improving comps (last 3 days)", avgPlacementImproved: "Avg placement improved by {value}",
