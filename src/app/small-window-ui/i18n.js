...
export const messages = {
  ...
  "en-US": {
    ...
    seasonName: "Cosmic", seasonPbePreview: "PBE", seasonSwitch: "Season", seasonSwitchLabel: "Choose season", seasonLiveStatus: "Live", seasonPbeStatus: "PBE", seasonRevivalStatus: "Revival", seasonArchivedStatus: "Archived", seasonComingSoonStatus: "Coming soon", seasonUnavailableStatus: "Unavailable", seasonSwitched: "Switched to {season}", seasonLoadFailed: "Could not load seasons", seasonSwitchFailed: "Could not switch seasons", seasonPreviewMode: "Set 18 PBE unavailable", seasonPreviewQueryDisabled: "The PBE data source is unavailable. Queries are paused instead of falling back to another season.", patchNotesUnavailable: "No patch notes are available for this season.", languageLabel: "Language", settings: "Settings",
