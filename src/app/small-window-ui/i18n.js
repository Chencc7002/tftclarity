...
export const messages = {
  "zh-CN": {
    ...
    quickTaskFormEyebrow: "快捷查询", quickTaskFormHint: "只填写输入框，发送时会自动组成查询语句。", closeQuickTaskForm: "取消快捷填写",
  ...
  "en-US": {
    ...
    seasonName: "Cosmic", seasonPbePreview: "PBE Preview", seasonSwitch: "Season", seasonSwitchLabel: "Choose season", seasonLiveStatus: "Live", seasonPbeStatus: "PBE", seasonRevivalStatus: "Revival", seasonArchivedStatus: "Archived", seasonComingSoonStatus: "Coming soon", seasonUnavailableStatus: "Unavailable", seasonSwitched: "Switched to {season}", seasonLoadFailed: "Could not load seasons", seasonSwitchFailed: "Could not switch seasons", seasonPreviewMode: "S18 theme preview", seasonPreviewQueryDisabled: "PBE data is not connected yet. The interface is available for preview, but queries are disabled.", patchNotesUnavailable: "No patch notes are available for this season.", languageLabel: "Language", settings: "Settings",
    ...
    quickTaskFormEyebrow: "Quick query", quickTaskFormHint: "Fill the fields only. The query sentence is assembled when you send.", closeQuickTaskForm: "Cancel quick fill",
