...
export const messages = {
  "zh-CN": {
    ...
    quickCategoryLibraryTitle: "资料百科", quickCategoryLibraryBody: "英雄、装备与羁绊资料", quickCategoryLibraryCount: "3 项",
    quickCategoryNewsTitle: "版本资讯", quickCategoryNewsBody: "版本公告与重点改动", quickCategoryNewsCount: "1 项",
    ...
    quickTaskCompletionTitle: "两件补装", quickTaskCompletionBody: "需要英雄与已有两件装备", quickTaskCompletionExample: "示例：已有两件装备，第三件出什么？",
    quickTaskPerformanceTitle: "单件装备评估", quickTaskPerformanceBody: "需要英雄与一件装备", quickTaskPerformanceExample: "示例：某件装备在指定英雄身上表现怎么样？",
    quickTaskComparisonTitle: "装备对比", quickTaskComparisonBody: "需要英雄与两件待比较装备", quickTaskComparisonExample: "示例：指定英雄带哪件装备更好？",
    quickTaskCarriersTitle: "装备适配英雄", quickTaskCarriersBody: "指定装备查询正提升携带者", quickTaskCarriersExample: "示例：某件装备最适合哪些英雄携带？",
    ...
    quickTaskBuildTemplate: "查询【英雄名称】的当前版本最稳三件装备", quickTaskCompletionTemplate: "查询【英雄名称】已有【装备一】和【装备二】时的第三件装备",
    quickTaskPerformanceTemplate: "【装备名称】在【英雄名称】身上表现怎么样", quickTaskComparisonTemplate: "比较【英雄名称】使用【装备一】和【装备二】时的表现",
    quickTaskCarriersTemplate: "【装备名称】最适合哪些英雄携带", quickTaskSpecialTemplate: "查询【英雄名称】的【神器或光明装备】排行",
    quickTaskHeroCompsTemplate: "查询包含【英雄名称】的热门阵容", quickTaskUnitDetailsTemplate: "查询【英雄名称】的技能、费用和羁绊资料",
    quickTaskItemDetailsTemplate: "查询【装备名称】的效果和合成方式", quickTaskTraitDetailsTemplate: "查询【羁绊名称】的效果和激活层级",
    quickTaskBuildSelection: "【英雄名称】", quickTaskItemSelection: "【装备名称】", quickTaskTraitSelection: "【羁绊名称】", completeQuickTaskFields: "请先填写模板中所有标记的内容",
    ...
    applicabilityRecommendation: "普适推荐", applicabilityScore: "普适评分", applicabilityScoreValue: "稳健分 {score}", sampleCoverageValue: "样本置信度 {value}%", applicabilityMethodShort: "已校正小样本波动；按表现与平方根样本置信度连续评分",
  ...
  "en-US": {
    ...
    quickCategoryLibraryTitle: "Reference library", quickCategoryLibraryBody: "Champions, items, and traits", quickCategoryLibraryCount: "3 tasks",
    quickCategoryNewsTitle: "Patch updates", quickCategoryNewsBody: "Release notes and key changes", quickCategoryNewsCount: "1 task",
    ...
    quickTaskCompletionTitle: "Complete a build", quickTaskCompletionBody: "Requires a champion and two owned items", quickTaskCompletionExample: "Example: With two items owned, what should the third be?",
    quickTaskPerformanceTitle: "Evaluate one item", quickTaskPerformanceBody: "Requires a champion and one item", quickTaskPerformanceExample: "Example: How does one item perform on a chosen champion?",
    ...
    quickTaskCarriersTitle: "Best item carriers", quickTaskCarriersBody: "Find positive-uplift carriers for one item", quickTaskCarriersExample: "Example: Which champions carry this item best?",
    ...
    quickTaskBuildTemplate: "Show the most stable current build for [champion name]", quickTaskCompletionTemplate: "For [champion name] with [first item] and [second item], recommend the third item",
    quickTaskPerformanceTemplate: "How does [item name] perform on [champion name]?", quickTaskComparisonTemplate: "Compare [first item] and [second item] on [champion name]",
    quickTaskCarriersTemplate: "Which champions carry [item name] best?", quickTaskSpecialTemplate: "Rank [artifact or Radiant items] for [champion name]",
    quickTaskHeroCompsTemplate: "Show popular comps containing [champion name]", quickTaskUnitDetailsTemplate: "Show the ability, cost, and traits for [champion name]",
    quickTaskItemDetailsTemplate: "Show the effect and recipe for [item name]", quickTaskTraitDetailsTemplate: "Show the effect and activation tiers for [trait name]",
    quickTaskBuildSelection: "[champion name]", quickTaskItemSelection: "[item name]", quickTaskTraitSelection: "[trait name]", completeQuickTaskFields: "Complete every marked field in the template first",
    ...
    applicabilityRecommendation: "Broad-use pick", applicabilityScore: "Applicability score", applicabilityScoreValue: "Robust score {score}", sampleCoverageValue: "Sample confidence {value}%", applicabilityMethodShort: "Small-sample volatility adjusted; performance and square-root sample confidence are scored continuously",
