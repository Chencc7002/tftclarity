...
export const ITEM_ALIAS_OVERRIDES = [
  ...
  },
  {
    ...
    aliases: ["Flora Fatalis Emblem", "花妖纹章", "绝命花妖转", "花妖转"],
    preferZhName: true,
    confidence: 1,
    source: "manual_from_verified_s18_trait_name",
    season: "TFT18"
  },
  {
    ...
    zhName: "强化版绝命花妖纹章",
    shortName: "强化版绝命花妖纹章",
    preferredDisplayName: "强化版绝命花妖纹章",
    aliases: ["Flora Fatalis Emblem Augment", "绝命花妖强化纹章"],
    excludedAliases: ["绝命花妖纹章", "Flora Fatalis Emblem"],
    preferZhName: true,
    confidence: 1,
    source: "manual_from_verified_s18_trait_name",
    season: "TFT18"
  ...
  },
  {
    ...
    zhName: "饮血剑",
    shortName: "饮血",
    aliases: ["饮血", "饮血剑", "bt", "bloodthirster"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "蓝霸符",
    shortName: "蓝buff",
    aliases: ["蓝buff", "蓝霸符", "蓝", "bluebuff", "blue buff"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "棘刺背心",
    shortName: "反甲",
    aliases: ["反甲", "棘刺背心", "bramble", "bramble vest"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "巨龙之爪",
    shortName: "龙牙",
    aliases: ["龙牙", "巨龙之爪", "dclaw", "dragonclaw", "dragon's claw"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "石像鬼石板甲",
    shortName: "石像鬼",
    aliases: ["石像鬼", "石像鬼石板甲", "板甲", "gargoyle", "gargoyle stoneplate"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "离子火花",
    shortName: "离子",
    aliases: ["离子", "离子火花", "ionicspark", "ionic spark"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "珠光护手",
    shortName: "法爆",
    aliases: ["法爆", "珠光", "珠光护手", "jg", "jeweled gauntlet"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "莫雷洛秘典",
    shortName: "鬼书",
    aliases: ["鬼书", "莫雷洛", "莫雷洛秘典", "morello", "morellonomicon"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "灭世者的死亡之帽",
    shortName: "帽子",
    aliases: ["帽子", "大帽", "大帽子", "灭世者的死亡之帽", "rabadon", "deathcap"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "斯特拉克的挑战护手",
    shortName: "血手",
    aliases: ["血手", "斯特拉克", "斯特拉克的挑战护手", "sterak", "steraks"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "泰坦的坚决",
    shortName: "泰坦",
    aliases: ["泰坦", "泰坦的坚决", "titans", "titan's resolve"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "狂徒铠甲",
    shortName: "狂徒",
    aliases: ["狂徒", "狂徒铠甲", "warmog", "warmogs"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "窃贼手套",
    shortName: "偷偷",
    aliases: ["偷偷", "偷手套", "窃贼手套", "thief", "thiefs gloves"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "适应性头盔",
    shortName: "头盔",
    aliases: ["头盔", "适应性头盔", "adaptive helm"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "大天使之杖",
    shortName: "大天使",
    aliases: ["大天使", "大天使之杖", "archangel", "archangels"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "反曲之弓",
    shortName: "弓",
    aliases: ["弓", "反曲弓", "反曲之弓", "recurve bow"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "拳套",
    shortName: "拳套",
    aliases: ["拳套", "gloves", "sparring gloves"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "正义之手",
    shortName: "正义",
    aliases: ["正义", "正义之手", "hoj", "hand of justice"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "卢登的激荡",
    shortName: "卢登",
    aliases: ["卢登", "卢登的激荡", "luden", "ludens tempest"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "暗行者之爪",
    shortName: "暗爪",
    aliases: ["暗爪", "暗行者之爪", "prowler", "prowlers claw"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "飞升护符",
    shortName: "飞升",
    aliases: ["飞升", "飞升护符", "talisman of ascension"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "智慧末刃",
    shortName: "智慧末刃",
    aliases: ["智慧末刃", "智慧末", "wits end", "wit's end"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "三相之力",
    shortName: "三相",
    aliases: ["三相", "三相之力", "infinity force"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "中娅悖论",
    shortName: "金身",
    aliases: ["金身", "中娅", "中娅悖论", "zhonya", "zhonyas paradox"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "德玛西亚王冠",
    shortName: "德玛王冠",
    aliases: ["德玛王冠", "德玛西亚王冠", "crown of demacia"],
    confidence: 1,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    zhName: "黎明圣盾",
    shortName: "黎明盾",
    aliases: ["黎明盾", "黎明圣盾", "aegis of dawn"],
    confidence: 0.8,
    source: "manual"
  },
  {
  ...
  },
  {
    ...
    aliases: ["Cappa Juice", "cappa juice", "cappajuice"],
    confidence: 1,
    source: "riot_tft_patch_notes_en"
  },
  {
  ...
  },
  {
    ...
    zhName: "投机者之刃",
    shortName: "投机刀",
    aliases: ["投机刀", "投机者之刃", "赌徒之刃", "gamblers blade", "gambler's blade"],
    confidence: 1,
    source: "manual"
  },
  {
    ...
    zhName: "大亨之铠",
    shortName: "大亨甲",
    aliases: ["大亨甲", "大亨之铠", "moguls mail", "mogul's mail"],
    confidence: 1,
    source: "manual"
  }
];

export const itemAliasOverrideByApiName = new Map(
  ITEM_ALIAS_OVERRIDES.map((override) => [override.apiName, override])
);
